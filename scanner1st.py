...
OUTPUT_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "signals1st.json")
...
def run_scan():
    ...
    print(f"  Done. {len(all_signals)} total, {len(top10)} in Top 10. Written to signals1st.json")
